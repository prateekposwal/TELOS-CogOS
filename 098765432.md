...
- A social network, driver ratings platform, or dating app
...
## 6.1 Three delivery levels

### Option A — Pilot V1

**AUD $395,000**

For proving the product-market hypothesis with controlled operations.

- Core QR + plate contact flow
- Simplified abuse detection (rule-based)
- Lighter moderation workflows (manual processes)
- Reduced compliance documentation (PIA-ready architecture, full PIA deferred)
- Basic security testing (OWASP baseline)
- Limited admin analytics
- No formal load testing

**Timeline:** 16–18 weeks.

### Option B — Production V1 (Recommended)
...
## 6.2 Option B — Detailed Financial Breakdown
...
Based on Option B (AUD $495,000 build).
...
**Founded 2019, Riyadh. Series A. AI-powered Hiring Operating System.** 1.7M+ recruiters globally, 3M+ job fulfillments, 2M+ video interviews, 56B AI matching decisions. Products: EVA-REC, EVA-SSESS, EVA-BOARD. 15+ languages. SAP, Oracle, Zoom, Microsoft Teams, LinkedIn integrations.
