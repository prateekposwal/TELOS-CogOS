...
decision *is* the intelligence). Coordination is sustainable because the **cost of reconciling contributors
stays low enough that the consensus is at least as good as the best single
contributor** (Λ4.11: U_group − C_align ≥ max_i U_i — a consensus test, NOT
strict superadditivity): a transparent rule ledger makes
...
Intelligence)** — it is a market embodiment where the *consensus* is made *at least as good as* the
best-agent-isolated outcome by keeping alignment cost low (cooperation-through-consensus, not strict
superadditivity).
