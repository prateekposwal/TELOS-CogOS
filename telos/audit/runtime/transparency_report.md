...
| Average Mission Drift (MD) | 0.257 |
...
Average MD of 0.257 means the system's world model is well-calibrated.
...
| PlanningStream | 0.5 | yes | plan_trajectory | 0.94ms |
