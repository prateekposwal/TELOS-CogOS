...
| Average Mission Drift (MD) | 0.239 |
...
Average MD of 0.239 means the system's world model is well-calibrated.
...
| PlanningStream | 0.5 | yes | plan_trajectory | 1.09ms |
