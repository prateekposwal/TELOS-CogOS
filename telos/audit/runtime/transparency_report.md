...
| Average Mission Drift (MD) | 0.231 |
...
Average MD of 0.231 means the system's world model is well-calibrated.
...
| PlanningStream | 0.5 | yes | plan_trajectory | 1.59ms |
